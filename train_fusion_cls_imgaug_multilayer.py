...
import fire
from models_fusion_cls_imgaug import SurvivalModel
import xlrd
...
def main(data_path='data', excel_1200_path='SYU_1200.xlsx', excel_500_path='south_hospital_700.xlsx'):
    ...
    for row in range(2, sheet_1200.nrows):
        if str(sheet_1200.row_values(row)[select_index+offset_1200]):
    ...
    survival_model.fit(datasets_train, datasets_val, datasets_test, train_name, val_name, test_name, loss_func='cross_entropy', epochs=500, lr=0.0001, mode='train', batch_size = 16)
