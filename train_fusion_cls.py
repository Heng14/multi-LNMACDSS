...
import fire
from models_fusion_cls import SurvivalModel
import xlrd
...
def main(data_path='data', excel_1200_path='SYU_1200.xlsx', excel_500_path='south_hospital_700.xlsx'):
    ...
    survival_model.fit(datasets_train, datasets_val, datasets_test, train_name, val_name, test_name, loss_func='cross_entropy', epochs=1000, lr=0.0001, mode='train', batch_size = 32)
